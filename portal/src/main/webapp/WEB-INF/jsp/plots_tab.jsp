...
<script type="text/javascript" src="js/src/plots-tab/PlotsTab.js<%=GlobalProperties.getAppVersion()%>"></script>
<script type="text/javascript" src="js/src/plots-tab/plots-tab-one-gene.js<%=GlobalProperties.getAppVersion()%>"></script>
