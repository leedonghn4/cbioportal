<script type="text/javascript" src="js/src/co-expression-tab/CoexpPlots.js<%=GlobalProperties.getAppVersion()%>"></script>
<script type="text/javascript" src="js/src/co-expression-tab/CoexpPlotsProxy.js<%=GlobalProperties.getAppVersion()%>"></script>
<script type="text/javascript" src="js/src/co-expression-tab/CoexpPlotsView.js<%=GlobalProperties.getAppVersion()%>"></script>
<script type="text/javascript" src="js/src/co-expression-tab/coExpression.js<%=GlobalProperties.getAppVersion()%>"></script>
<script type="text/javascript" src="js/lib/portal-plots/PlotsBoilerplate.js<%=GlobalProperties.getAppVersion()%>"></script>
<script type="text/javascript" src="js/lib/portal-plots/PlotsHeader.js<%=GlobalProperties.getAppVersion()%>"></script>
<script type="text/javascript" src="js/lib/portal-plots/ScatterPlots.js<%=GlobalProperties.getAppVersion()%>"></script>
