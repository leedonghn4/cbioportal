...
AppRouter = Backbone.Router.extend({
    ...
    home: function(actions) {
        ...
        jQuery.getJSON("portal_meta_data.json", function(portalData) {
            var studiesLoadedView = new StudiesLoadedView({ model: portalData });
...
StudiesLoadedView = Backbone.View.extend({
    ...
    render: function() {
        $(this.el).html("");
        console.log("Studies loaded: " + this.model.cancer_studies.length);
        return this;
    }
});
