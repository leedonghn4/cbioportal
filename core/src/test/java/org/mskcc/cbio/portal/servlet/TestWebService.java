...
//              (publicGeneticProfile.getCancerStudyId()).getCancerStudyStableId()));
   ...
   private void setUpDBMS() throws DaoException, IOException{
      ...
      privateCancerStudy1 = new CancerStudy( "name", "description", "study1",-1,"", "brca", false );
      DaoCancerStudy.addCancerStudy(privateCancerStudy1);  // 1
      privateCancerStudy2 = new CancerStudy( "other name", "other description","",-1, "study2", "brca", false );
      DaoCancerStudy.addCancerStudy(privateCancerStudy2);  // 2
      
      publicCancerStudy = new CancerStudy( "public name", "description", "study3",-1,"", "brca", true );
